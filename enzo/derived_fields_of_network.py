...
def element_H_ndensity(field, data):
    ...
    if data.ds.parameters['MultiSpecies'] < 4:
        return
    arr = (0.0 + 2*data['GH2CNI_ndensity'] + 1*data['GHNCI_ndensity'] +
          ...
          2*data['H2SiOI_ndensity'] + 1*data['HeHII_ndensity'] +
...
def element_HE_ndensity(field, data):
    ...
    if data.ds.parameters['MultiSpecies'] < 4:
        return
    arr = (0.0 + 1*data['HeHII_ndensity'] + 1*data['HeII_ndensity'] +
          1*data['HeI_ndensity'])
    return arr
...
def element_C_ndensity(field, data):
    ...
    if data.ds.parameters['MultiSpecies'] < 4:
        return
    arr = (0.0 + 1*data['GH2CNI_ndensity'] + 1*data['GHNCI_ndensity'] +
...
def element_O_ndensity(field, data):
    ...
    if data.ds.parameters['MultiSpecies'] < 4:
        return
    arr = (0.0 + 2*data['GNO2I_ndensity'] + 1*data['GSiOI_ndensity'] +
          1*data['GCOI_ndensity'] + 1*data['GHNCOI_ndensity'] +
...
def element_SI_ndensity(field, data):
    ...
    if data.ds.parameters['MultiSpecies'] < 4:
        return
    arr = (0.0 + 1*data['GSiOI_ndensity'] + 1*data['GSiCI_ndensity'] +
