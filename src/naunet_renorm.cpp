...
int InitRenorm(realtype *ab, SUNMatrix A) {
    ...
    IJth(A, IDX_ELEM_C, IDX_ELEM_C) = 0.0 + 12.0 * ab[IDX_GCH3OHI] / 32.0 /
                                    ...
                                    Hnuclei + 12.0 * ab[IDX_CI] / 12.0 / Hnuclei
                                    + 12.0 * ab[IDX_CII] / 12.0 / Hnuclei + 12.0
                                    * ab[IDX_CHI] / 13.0 / Hnuclei + 12.0 *
                                    ...
                                    ab[IDX_SiC2I] / 52.0 / Hnuclei + 48.0 *
                                    ab[IDX_SiC2II] / 52.0 / Hnuclei + 108.0 *
                                    ab[IDX_SiC3I] / 64.0 / Hnuclei + 108.0 *
                                    ab[IDX_SiC3II] / 64.0 / Hnuclei;
    IJth(A, IDX_ELEM_C, IDX_ELEM_H) = 0.0 + 4.0 * ab[IDX_GCH3OHI] / 32.0 / Hnuclei
                                    + 4.0 * ab[IDX_GCH4I] / 16.0 / Hnuclei + 2.0
                                    * ab[IDX_GH2CNI] / 28.0 / Hnuclei + 2.0 *
                                    ab[IDX_GH2COI] / 30.0 / Hnuclei + 1.0 *
                                    ab[IDX_GHCNI] / 27.0 / Hnuclei + 1.0 *
                                    ab[IDX_GHNCI] / 27.0 / Hnuclei + 1.0 *
                                    ...
                                    ab[IDX_H2COI] / 30.0 / Hnuclei + 2.0 *
                                    ab[IDX_H2COII] / 30.0 / Hnuclei + 3.0 *
    ...
    IJth(A, IDX_ELEM_C, IDX_ELEM_N) = 0.0 + 14.0 * ab[IDX_GH2CNI] / 28.0 / Hnuclei
                                    + 14.0 * ab[IDX_GHCNI] / 27.0 / Hnuclei +
                                    14.0 * ab[IDX_GHNCI] / 27.0 / Hnuclei + 14.0
    ...
    IJth(A, IDX_ELEM_C, IDX_ELEM_SI) = 0.0 + 28.0 * ab[IDX_GSiCI] / 40.0 / Hnuclei
                                    ...
                                    28.0 * ab[IDX_SiCI] / 40.0 / Hnuclei + 28.0
                                    * ab[IDX_SiCII] / 40.0 / Hnuclei + 56.0 *
                                    ab[IDX_SiC2I] / 52.0 / Hnuclei + 56.0 *
                                    ab[IDX_SiC2II] / 52.0 / Hnuclei + 84.0 *
                                    ab[IDX_SiC3I] / 64.0 / Hnuclei + 84.0 *
                                    ab[IDX_SiC3II] / 64.0 / Hnuclei;
    ...
    IJth(A, IDX_ELEM_H, IDX_ELEM_H) = 0.0 + 16.0 * ab[IDX_GCH3OHI] / 32.0 /
                                    Hnuclei + 16.0 * ab[IDX_GCH4I] / 16.0 /
                                    Hnuclei + 4.0 * ab[IDX_GH2CNI] / 28.0 /
                                    Hnuclei + 4.0 * ab[IDX_GH2COI] / 30.0 /
                                    Hnuclei + 4.0 * ab[IDX_GH2OI] / 18.0 /
                                    Hnuclei + 4.0 * ab[IDX_GH2SiOI] / 46.0 /
                                    Hnuclei + 1.0 * ab[IDX_GHCNI] / 27.0 /
                                    Hnuclei + 1.0 * ab[IDX_GHNCI] / 27.0 /
                                    Hnuclei + 1.0 * ab[IDX_GHNCOI] / 43.0 /
                                    Hnuclei + 1.0 * ab[IDX_GHNOI] / 31.0 /
                                    Hnuclei + 9.0 * ab[IDX_GNH3I] / 17.0 /
                                    Hnuclei + 1.0 * ab[IDX_GO2HI] / 33.0 /
                                    Hnuclei + 16.0 * ab[IDX_GSiH4I] / 32.0 /
                                    Hnuclei + 1.0 * ab[IDX_CHI] / 13.0 / Hnuclei
                                    + 1.0 * ab[IDX_CHII] / 13.0 / Hnuclei + 4.0
                                    * ab[IDX_CH2I] / 14.0 / Hnuclei + 4.0 *
                                    ab[IDX_CH2II] / 14.0 / Hnuclei + 9.0 *
                                    ab[IDX_CH3I] / 15.0 / Hnuclei + 9.0 *
                                    ab[IDX_CH3II] / 15.0 / Hnuclei + 16.0 *
                                    ab[IDX_CH3OHI] / 32.0 / Hnuclei + 16.0 *
                                    ab[IDX_CH4I] / 16.0 / Hnuclei + 16.0 *
                                    ab[IDX_CH4II] / 16.0 / Hnuclei + 1.0 *
                                    ab[IDX_HI] / 1.0 / Hnuclei + 1.0 *
                                    ab[IDX_HII] / 1.0 / Hnuclei + 4.0 *
                                    ab[IDX_H2I] / 2.0 / Hnuclei + 4.0 *
                                    ab[IDX_H2II] / 2.0 / Hnuclei + 4.0 *
                                    ...
                                    ab[IDX_H3II] / 3.0 / Hnuclei + 9.0 *
                                    ab[IDX_H3COII] / 31.0 / Hnuclei + 9.0 *
                                    ...
                                    ab[IDX_SiH2I] / 30.0 / Hnuclei + 4.0 *
                                    ab[IDX_SiH2II] / 30.0 / Hnuclei + 9.0 *
                                    ab[IDX_SiH3I] / 31.0 / Hnuclei + 9.0 *
                                    ab[IDX_SiH3II] / 31.0 / Hnuclei + 16.0 *
                                    ab[IDX_SiH4I] / 32.0 / Hnuclei + 16.0 *
    ...
    IJth(A, IDX_ELEM_H, IDX_ELEM_N) = 0.0 + 28.0 * ab[IDX_GH2CNI] / 28.0 / Hnuclei
                                    ...
                                    14.0 * ab[IDX_GHNCI] / 27.0 / Hnuclei + 14.0
                                    * ab[IDX_GHNCOI] / 43.0 / Hnuclei + 14.0 *
                                    ab[IDX_GHNOI] / 31.0 / Hnuclei + 42.0 *
                                    ...
                                    ab[IDX_HNOII] / 31.0 / Hnuclei + 28.0 *
                                    ab[IDX_N2HII] / 29.0 / Hnuclei + 14.0 *
                                    ab[IDX_NHI] / 15.0 / Hnuclei + 14.0 *
                                    ab[IDX_NHII] / 15.0 / Hnuclei + 28.0 *
                                    ab[IDX_NH2I] / 16.0 / Hnuclei + 28.0 *
                                    ab[IDX_NH2II] / 16.0 / Hnuclei + 42.0 *
                                    ab[IDX_NH3I] / 17.0 / Hnuclei + 42.0 *
                                    ab[IDX_NH3II] / 17.0 / Hnuclei;
    ...
    IJth(A, IDX_ELEM_N, IDX_ELEM_C) = 0.0 + 12.0 * ab[IDX_GH2CNI] / 28.0 / Hnuclei
                                    + 12.0 * ab[IDX_GHCNI] / 27.0 / Hnuclei +
                                    12.0 * ab[IDX_GHNCI] / 27.0 / Hnuclei + 12.0
    ...
    IJth(A, IDX_ELEM_N, IDX_ELEM_H) = 0.0 + 2.0 * ab[IDX_GH2CNI] / 28.0 / Hnuclei
                                    + 1.0 * ab[IDX_GHCNI] / 27.0 / Hnuclei + 1.0
                                    * ab[IDX_GHNCI] / 27.0 / Hnuclei + 1.0 *
                                    ab[IDX_GHNCOI] / 43.0 / Hnuclei + 1.0 *
                                    ab[IDX_GHNOI] / 31.0 / Hnuclei + 3.0 *
                                    ...
                                    ab[IDX_NH2II] / 16.0 / Hnuclei + 3.0 *
                                    ab[IDX_NH3I] / 17.0 / Hnuclei + 3.0 *
                                    ab[IDX_NH3II] / 17.0 / Hnuclei;
    ...
    IJth(A, IDX_ELEM_N, IDX_ELEM_N) = 0.0 + 14.0 * ab[IDX_GH2CNI] / 28.0 / Hnuclei
                                    ...
                                    * ab[IDX_GHNCOI] / 43.0 / Hnuclei + 14.0 *
                                    ...
                                    ab[IDX_GNO2I] / 46.0 / Hnuclei + 14.0 *
                                    ab[IDX_CNI] / 26.0 / Hnuclei + 14.0 *
                                    ab[IDX_CNII] / 26.0 / Hnuclei + 14.0 *
                                    ab[IDX_H2CNI] / 28.0 / Hnuclei + 14.0 *
                                    ab[IDX_H2NOII] / 32.0 / Hnuclei + 14.0 *
                                    ...
                                    ab[IDX_NI] / 14.0 / Hnuclei + 14.0 *
                                    ab[IDX_NII] / 14.0 / Hnuclei + 56.0 *
                                    ab[IDX_N2I] / 28.0 / Hnuclei + 56.0 *
                                    ab[IDX_N2II] / 28.0 / Hnuclei + 56.0 *
                                    ab[IDX_N2HII] / 29.0 / Hnuclei + 14.0 *
                                    ab[IDX_NHI] / 15.0 / Hnuclei + 14.0 *
                                    ...
                                    ab[IDX_OCNI] / 42.0 / Hnuclei;
    IJth(A, IDX_ELEM_N, IDX_ELEM_O) = 0.0 + 16.0 * ab[IDX_GHNCOI] / 43.0 / Hnuclei
                                    + 16.0 * ab[IDX_GHNOI] / 31.0 / Hnuclei +
                                    16.0 * ab[IDX_GNOI] / 30.0 / Hnuclei + 32.0
                                    * ab[IDX_GNO2I] / 46.0 / Hnuclei + 16.0 *
    ...
    IJth(A, IDX_ELEM_O, IDX_ELEM_C) = 0.0 + 12.0 * ab[IDX_GCH3OHI] / 32.0 /
                                    ...
                                    Hnuclei;
    IJth(A, IDX_ELEM_O, IDX_ELEM_H) = 0.0 + 4.0 * ab[IDX_GCH3OHI] / 32.0 / Hnuclei
                                    + 2.0 * ab[IDX_GH2COI] / 30.0 / Hnuclei +
                                    2.0 * ab[IDX_GH2OI] / 18.0 / Hnuclei + 2.0 *
                                    ...
                                    ab[IDX_H2OI] / 18.0 / Hnuclei + 2.0 *
                                    ab[IDX_H2OII] / 18.0 / Hnuclei + 2.0 *
                                    ab[IDX_H2SiOI] / 46.0 / Hnuclei + 3.0 *
                                    ab[IDX_H3COII] / 31.0 / Hnuclei + 3.0 *
                                    ab[IDX_H3OII] / 19.0 / Hnuclei + 1.0 *
                                    ab[IDX_HCOI] / 29.0 / Hnuclei + 1.0 *
    ...
    IJth(A, IDX_ELEM_O, IDX_ELEM_N) = 0.0 + 14.0 * ab[IDX_GHNCOI] / 43.0 / Hnuclei
                                    + 14.0 * ab[IDX_GHNOI] / 31.0 / Hnuclei +
                                    14.0 * ab[IDX_GNOI] / 30.0 / Hnuclei + 28.0
                                    * ab[IDX_GNO2I] / 46.0 / Hnuclei + 14.0 *
                                    ab[IDX_H2NOII] / 32.0 / Hnuclei + 14.0 *
                                    ab[IDX_HNCOI] / 43.0 / Hnuclei + 14.0 *
                                    ab[IDX_HNOI] / 31.0 / Hnuclei + 14.0 *
    ...
    IJth(A, IDX_ELEM_O, IDX_ELEM_O) = 0.0 + 16.0 * ab[IDX_GCH3OHI] / 32.0 /
                                    ...
                                    + 16.0 * ab[IDX_OII] / 16.0 / Hnuclei + 64.0
                                    * ab[IDX_O2I] / 32.0 / Hnuclei + 64.0 *
                                    ab[IDX_O2II] / 32.0 / Hnuclei + 64.0 *
    ...
    IJth(A, IDX_ELEM_O, IDX_ELEM_SI) = 0.0 + 28.0 * ab[IDX_GH2SiOI] / 46.0 /
                                    Hnuclei + 28.0 * ab[IDX_GSiOI] / 44.0 /
                                    Hnuclei + 28.0 * ab[IDX_H2SiOI] / 46.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiOI] / 44.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiOII] / 44.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiOHII] / 45.0 /
                                    Hnuclei;
    IJth(A, IDX_ELEM_SI, IDX_ELEM_C) = 0.0 + 12.0 * ab[IDX_GSiCI] / 40.0 / Hnuclei
                                    ...
                                    12.0 * ab[IDX_SiCI] / 40.0 / Hnuclei + 12.0
                                    * ab[IDX_SiCII] / 40.0 / Hnuclei + 24.0 *
                                    ab[IDX_SiC2I] / 52.0 / Hnuclei + 24.0 *
                                    ab[IDX_SiC2II] / 52.0 / Hnuclei + 36.0 *
                                    ab[IDX_SiC3I] / 64.0 / Hnuclei + 36.0 *
                                    ab[IDX_SiC3II] / 64.0 / Hnuclei;
    IJth(A, IDX_ELEM_SI, IDX_ELEM_H) = 0.0 + 2.0 * ab[IDX_GH2SiOI] / 46.0 / Hnuclei
                                    + 4.0 * ab[IDX_GSiH4I] / 32.0 / Hnuclei +
                                    2.0 * ab[IDX_H2SiOI] / 46.0 / Hnuclei + 1.0
                                    * ab[IDX_SiHI] / 29.0 / Hnuclei + 1.0 *
                                    ab[IDX_SiHII] / 29.0 / Hnuclei + 2.0 *
                                    ab[IDX_SiH2I] / 30.0 / Hnuclei + 2.0 *
                                    ab[IDX_SiH2II] / 30.0 / Hnuclei + 3.0 *
                                    ab[IDX_SiH3I] / 31.0 / Hnuclei + 3.0 *
                                    ab[IDX_SiH3II] / 31.0 / Hnuclei + 4.0 *
                                    ab[IDX_SiH4I] / 32.0 / Hnuclei + 4.0 *
                                    ab[IDX_SiH4II] / 32.0 / Hnuclei + 5.0 *
                                    ab[IDX_SiH5II] / 33.0 / Hnuclei + 1.0 *
                                    ab[IDX_SiOHII] / 45.0 / Hnuclei;
    ...
    IJth(A, IDX_ELEM_SI, IDX_ELEM_SI) = 0.0 + 28.0 * ab[IDX_GH2SiOI] / 46.0 /
                                    ...
                                    Hnuclei + 28.0 * ab[IDX_GSiC2I] / 52.0 /
                                    Hnuclei + 28.0 * ab[IDX_GSiC3I] / 64.0 /
                                    Hnuclei + 28.0 * ab[IDX_GSiH4I] / 32.0 /
                                    Hnuclei + 28.0 * ab[IDX_GSiOI] / 44.0 /
                                    Hnuclei + 28.0 * ab[IDX_H2SiOI] / 46.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiI] / 28.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiII] / 28.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiCI] / 40.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiCII] / 40.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiC2I] / 52.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiC2II] / 52.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiC3I] / 64.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiC3II] / 64.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiHI] / 29.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiHII] / 29.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiH2I] / 30.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiH2II] / 30.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiH3I] / 31.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiH3II] / 31.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiH4I] / 32.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiH4II] / 32.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiH5II] / 33.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiOI] / 44.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiOII] / 44.0 /
                                    Hnuclei + 28.0 * ab[IDX_SiOHII] / 45.0 /
                                    Hnuclei;
...
int RenormAbundance(realtype *rptr, realtype *ab) {
    ...
    ab[IDX_GCH3OHI] = ab[IDX_GCH3OHI] * (12.0 * rptr[IDX_ELEM_C] / 32.0 + 4.0 * rptr[IDX_ELEM_H] / 32.0 + 16.0 * rptr[IDX_ELEM_O] / 32.0);
    ...
    ab[IDX_GH2CNI] = ab[IDX_GH2CNI] * (12.0 * rptr[IDX_ELEM_C] / 28.0 + 2.0 * rptr[IDX_ELEM_H] / 28.0 + 14.0 * rptr[IDX_ELEM_N] / 28.0);
    ab[IDX_GH2COI] = ab[IDX_GH2COI] * (12.0 * rptr[IDX_ELEM_C] / 30.0 + 2.0 * rptr[IDX_ELEM_H] / 30.0 + 16.0 * rptr[IDX_ELEM_O] / 30.0);
    ab[IDX_GH2OI] = ab[IDX_GH2OI] * (2.0 * rptr[IDX_ELEM_H] / 18.0 + 16.0 * rptr[IDX_ELEM_O] / 18.0);
    ab[IDX_GH2SiOI] = ab[IDX_GH2SiOI] * (2.0 * rptr[IDX_ELEM_H] / 46.0 + 16.0 * rptr[IDX_ELEM_O] / 46.0 + 28.0 * rptr[IDX_ELEM_SI] / 46.0);
    ab[IDX_GHCNI] = ab[IDX_GHCNI] * (12.0 * rptr[IDX_ELEM_C] / 27.0 + 1.0 * rptr[IDX_ELEM_H] / 27.0 + 14.0 * rptr[IDX_ELEM_N] / 27.0);
    ab[IDX_GHNCI] = ab[IDX_GHNCI] * (12.0 * rptr[IDX_ELEM_C] / 27.0 + 1.0 * rptr[IDX_ELEM_H] / 27.0 + 14.0 * rptr[IDX_ELEM_N] / 27.0);
    ab[IDX_GHNCOI] = ab[IDX_GHNCOI] * (12.0 * rptr[IDX_ELEM_C] / 43.0 + 1.0 * rptr[IDX_ELEM_H] / 43.0 + 14.0 * rptr[IDX_ELEM_N] / 43.0 + 16.0 * rptr[IDX_ELEM_O] / 43.0);
    ab[IDX_GHNOI] = ab[IDX_GHNOI] * (1.0 * rptr[IDX_ELEM_H] / 31.0 + 14.0 * rptr[IDX_ELEM_N] / 31.0 + 16.0 * rptr[IDX_ELEM_O] / 31.0);
    ab[IDX_GMgI] = ab[IDX_GMgI] * (24.0 * rptr[IDX_ELEM_MG] / 24.0);
    ab[IDX_GN2I] = ab[IDX_GN2I] * (28.0 * rptr[IDX_ELEM_N] / 28.0);
    ab[IDX_GNH3I] = ab[IDX_GNH3I] * (3.0 * rptr[IDX_ELEM_H] / 17.0 + 14.0 * rptr[IDX_ELEM_N] / 17.0);
    ...
    ab[IDX_GO2HI] = ab[IDX_GO2HI] * (1.0 * rptr[IDX_ELEM_H] / 33.0 + 32.0 * rptr[IDX_ELEM_O] / 33.0);
    ab[IDX_GSiCI] = ab[IDX_GSiCI] * (12.0 * rptr[IDX_ELEM_C] / 40.0 + 28.0 * rptr[IDX_ELEM_SI] / 40.0);
    ab[IDX_GSiC2I] = ab[IDX_GSiC2I] * (24.0 * rptr[IDX_ELEM_C] / 52.0 + 28.0 * rptr[IDX_ELEM_SI] / 52.0);
    ab[IDX_GSiC3I] = ab[IDX_GSiC3I] * (36.0 * rptr[IDX_ELEM_C] / 64.0 + 28.0 * rptr[IDX_ELEM_SI] / 64.0);
    ab[IDX_GSiH4I] = ab[IDX_GSiH4I] * (4.0 * rptr[IDX_ELEM_H] / 32.0 + 28.0 * rptr[IDX_ELEM_SI] / 32.0);
    ab[IDX_GSiOI] = ab[IDX_GSiOI] * (16.0 * rptr[IDX_ELEM_O] / 44.0 + 28.0 * rptr[IDX_ELEM_SI] / 44.0);
    ...
    ab[IDX_CH3OHI] = ab[IDX_CH3OHI] * (12.0 * rptr[IDX_ELEM_C] / 32.0 + 4.0 * rptr[IDX_ELEM_H] / 32.0 + 16.0 * rptr[IDX_ELEM_O] / 32.0);
    ...
    ab[IDX_H2CNI] = ab[IDX_H2CNI] * (12.0 * rptr[IDX_ELEM_C] / 28.0 + 2.0 * rptr[IDX_ELEM_H] / 28.0 + 14.0 * rptr[IDX_ELEM_N] / 28.0);
    ab[IDX_H2COI] = ab[IDX_H2COI] * (12.0 * rptr[IDX_ELEM_C] / 30.0 + 2.0 * rptr[IDX_ELEM_H] / 30.0 + 16.0 * rptr[IDX_ELEM_O] / 30.0);
    ab[IDX_H2COII] = ab[IDX_H2COII] * (12.0 * rptr[IDX_ELEM_C] / 30.0 + 2.0 * rptr[IDX_ELEM_H] / 30.0 + 16.0 * rptr[IDX_ELEM_O] / 30.0);
    ab[IDX_H2NOII] = ab[IDX_H2NOII] * (2.0 * rptr[IDX_ELEM_H] / 32.0 + 14.0 * rptr[IDX_ELEM_N] / 32.0 + 16.0 * rptr[IDX_ELEM_O] / 32.0);
    ab[IDX_H2OI] = ab[IDX_H2OI] * (2.0 * rptr[IDX_ELEM_H] / 18.0 + 16.0 * rptr[IDX_ELEM_O] / 18.0);
    ab[IDX_H2OII] = ab[IDX_H2OII] * (2.0 * rptr[IDX_ELEM_H] / 18.0 + 16.0 * rptr[IDX_ELEM_O] / 18.0);
    ab[IDX_H2SiOI] = ab[IDX_H2SiOI] * (2.0 * rptr[IDX_ELEM_H] / 46.0 + 16.0 * rptr[IDX_ELEM_O] / 46.0 + 28.0 * rptr[IDX_ELEM_SI] / 46.0);
    ab[IDX_H3II] = ab[IDX_H3II] * (3.0 * rptr[IDX_ELEM_H] / 3.0);
    ab[IDX_H3COII] = ab[IDX_H3COII] * (12.0 * rptr[IDX_ELEM_C] / 31.0 + 3.0 * rptr[IDX_ELEM_H] / 31.0 + 16.0 * rptr[IDX_ELEM_O] / 31.0);
    ab[IDX_H3OII] = ab[IDX_H3OII] * (3.0 * rptr[IDX_ELEM_H] / 19.0 + 16.0 * rptr[IDX_ELEM_O] / 19.0);
    ab[IDX_HCNI] = ab[IDX_HCNI] * (12.0 * rptr[IDX_ELEM_C] / 27.0 + 1.0 * rptr[IDX_ELEM_H] / 27.0 + 14.0 * rptr[IDX_ELEM_N] / 27.0);
    ab[IDX_HCNII] = ab[IDX_HCNII] * (12.0 * rptr[IDX_ELEM_C] / 27.0 + 1.0 * rptr[IDX_ELEM_H] / 27.0 + 14.0 * rptr[IDX_ELEM_N] / 27.0);
    ab[IDX_HCNHII] = ab[IDX_HCNHII] * (12.0 * rptr[IDX_ELEM_C] / 28.0 + 2.0 * rptr[IDX_ELEM_H] / 28.0 + 14.0 * rptr[IDX_ELEM_N] / 28.0);
    ab[IDX_HCOI] = ab[IDX_HCOI] * (12.0 * rptr[IDX_ELEM_C] / 29.0 + 1.0 * rptr[IDX_ELEM_H] / 29.0 + 16.0 * rptr[IDX_ELEM_O] / 29.0);
    ab[IDX_HCOII] = ab[IDX_HCOII] * (12.0 * rptr[IDX_ELEM_C] / 29.0 + 1.0 * rptr[IDX_ELEM_H] / 29.0 + 16.0 * rptr[IDX_ELEM_O] / 29.0);
    ab[IDX_HCO2II] = ab[IDX_HCO2II] * (12.0 * rptr[IDX_ELEM_C] / 45.0 + 1.0 * rptr[IDX_ELEM_H] / 45.0 + 32.0 * rptr[IDX_ELEM_O] / 45.0);
    ab[IDX_HeI] = ab[IDX_HeI] * (4.0 * rptr[IDX_ELEM_HE] / 4.0);
    ab[IDX_HeII] = ab[IDX_HeII] * (4.0 * rptr[IDX_ELEM_HE] / 4.0);
    ab[IDX_HeHII] = ab[IDX_HeHII] * (1.0 * rptr[IDX_ELEM_H] / 5.0 + 4.0 * rptr[IDX_ELEM_HE] / 5.0);
    ab[IDX_HNCI] = ab[IDX_HNCI] * (12.0 * rptr[IDX_ELEM_C] / 27.0 + 1.0 * rptr[IDX_ELEM_H] / 27.0 + 14.0 * rptr[IDX_ELEM_N] / 27.0);
    ab[IDX_HNCOI] = ab[IDX_HNCOI] * (12.0 * rptr[IDX_ELEM_C] / 43.0 + 1.0 * rptr[IDX_ELEM_H] / 43.0 + 14.0 * rptr[IDX_ELEM_N] / 43.0 + 16.0 * rptr[IDX_ELEM_O] / 43.0);
    ab[IDX_HNOI] = ab[IDX_HNOI] * (1.0 * rptr[IDX_ELEM_H] / 31.0 + 14.0 * rptr[IDX_ELEM_N] / 31.0 + 16.0 * rptr[IDX_ELEM_O] / 31.0);
    ab[IDX_HNOII] = ab[IDX_HNOII] * (1.0 * rptr[IDX_ELEM_H] / 31.0 + 14.0 * rptr[IDX_ELEM_N] / 31.0 + 16.0 * rptr[IDX_ELEM_O] / 31.0);
    ab[IDX_HOCII] = ab[IDX_HOCII] * (12.0 * rptr[IDX_ELEM_C] / 29.0 + 1.0 * rptr[IDX_ELEM_H] / 29.0 + 16.0 * rptr[IDX_ELEM_O] / 29.0);
    ...
    ab[IDX_N2HII] = ab[IDX_N2HII] * (1.0 * rptr[IDX_ELEM_H] / 29.0 + 28.0 * rptr[IDX_ELEM_N] / 29.0);
    ab[IDX_NHI] = ab[IDX_NHI] * (1.0 * rptr[IDX_ELEM_H] / 15.0 + 14.0 * rptr[IDX_ELEM_N] / 15.0);
    ab[IDX_NHII] = ab[IDX_NHII] * (1.0 * rptr[IDX_ELEM_H] / 15.0 + 14.0 * rptr[IDX_ELEM_N] / 15.0);
    ab[IDX_NH2I] = ab[IDX_NH2I] * (2.0 * rptr[IDX_ELEM_H] / 16.0 + 14.0 * rptr[IDX_ELEM_N] / 16.0);
    ab[IDX_NH2II] = ab[IDX_NH2II] * (2.0 * rptr[IDX_ELEM_H] / 16.0 + 14.0 * rptr[IDX_ELEM_N] / 16.0);
    ab[IDX_NH3I] = ab[IDX_NH3I] * (3.0 * rptr[IDX_ELEM_H] / 17.0 + 14.0 * rptr[IDX_ELEM_N] / 17.0);
    ab[IDX_NH3II] = ab[IDX_NH3II] * (3.0 * rptr[IDX_ELEM_H] / 17.0 + 14.0 * rptr[IDX_ELEM_N] / 17.0);
    ...
    ab[IDX_O2HI] = ab[IDX_O2HI] * (1.0 * rptr[IDX_ELEM_H] / 33.0 + 32.0 * rptr[IDX_ELEM_O] / 33.0);
    ab[IDX_O2HII] = ab[IDX_O2HII] * (1.0 * rptr[IDX_ELEM_H] / 33.0 + 32.0 * rptr[IDX_ELEM_O] / 33.0);
    ab[IDX_OCNI] = ab[IDX_OCNI] * (12.0 * rptr[IDX_ELEM_C] / 42.0 + 14.0 * rptr[IDX_ELEM_N] / 42.0 + 16.0 * rptr[IDX_ELEM_O] / 42.0);
    ab[IDX_OHI] = ab[IDX_OHI] * (1.0 * rptr[IDX_ELEM_H] / 17.0 + 16.0 * rptr[IDX_ELEM_O] / 17.0);
    ab[IDX_OHII] = ab[IDX_OHII] * (1.0 * rptr[IDX_ELEM_H] / 17.0 + 16.0 * rptr[IDX_ELEM_O] / 17.0);
    ab[IDX_SiI] = ab[IDX_SiI] * (28.0 * rptr[IDX_ELEM_SI] / 28.0);
    ab[IDX_SiII] = ab[IDX_SiII] * (28.0 * rptr[IDX_ELEM_SI] / 28.0);
    ab[IDX_SiCI] = ab[IDX_SiCI] * (12.0 * rptr[IDX_ELEM_C] / 40.0 + 28.0 * rptr[IDX_ELEM_SI] / 40.0);
    ab[IDX_SiCII] = ab[IDX_SiCII] * (12.0 * rptr[IDX_ELEM_C] / 40.0 + 28.0 * rptr[IDX_ELEM_SI] / 40.0);
    ab[IDX_SiC2I] = ab[IDX_SiC2I] * (24.0 * rptr[IDX_ELEM_C] / 52.0 + 28.0 * rptr[IDX_ELEM_SI] / 52.0);
    ab[IDX_SiC2II] = ab[IDX_SiC2II] * (24.0 * rptr[IDX_ELEM_C] / 52.0 + 28.0 * rptr[IDX_ELEM_SI] / 52.0);
    ab[IDX_SiC3I] = ab[IDX_SiC3I] * (36.0 * rptr[IDX_ELEM_C] / 64.0 + 28.0 * rptr[IDX_ELEM_SI] / 64.0);
    ab[IDX_SiC3II] = ab[IDX_SiC3II] * (36.0 * rptr[IDX_ELEM_C] / 64.0 + 28.0 * rptr[IDX_ELEM_SI] / 64.0);
    ab[IDX_SiHI] = ab[IDX_SiHI] * (1.0 * rptr[IDX_ELEM_H] / 29.0 + 28.0 * rptr[IDX_ELEM_SI] / 29.0);
    ab[IDX_SiHII] = ab[IDX_SiHII] * (1.0 * rptr[IDX_ELEM_H] / 29.0 + 28.0 * rptr[IDX_ELEM_SI] / 29.0);
    ab[IDX_SiH2I] = ab[IDX_SiH2I] * (2.0 * rptr[IDX_ELEM_H] / 30.0 + 28.0 * rptr[IDX_ELEM_SI] / 30.0);
    ab[IDX_SiH2II] = ab[IDX_SiH2II] * (2.0 * rptr[IDX_ELEM_H] / 30.0 + 28.0 * rptr[IDX_ELEM_SI] / 30.0);
    ab[IDX_SiH3I] = ab[IDX_SiH3I] * (3.0 * rptr[IDX_ELEM_H] / 31.0 + 28.0 * rptr[IDX_ELEM_SI] / 31.0);
    ab[IDX_SiH3II] = ab[IDX_SiH3II] * (3.0 * rptr[IDX_ELEM_H] / 31.0 + 28.0 * rptr[IDX_ELEM_SI] / 31.0);
    ab[IDX_SiH4I] = ab[IDX_SiH4I] * (4.0 * rptr[IDX_ELEM_H] / 32.0 + 28.0 * rptr[IDX_ELEM_SI] / 32.0);
    ab[IDX_SiH4II] = ab[IDX_SiH4II] * (4.0 * rptr[IDX_ELEM_H] / 32.0 + 28.0 * rptr[IDX_ELEM_SI] / 32.0);
    ab[IDX_SiH5II] = ab[IDX_SiH5II] * (5.0 * rptr[IDX_ELEM_H] / 33.0 + 28.0 * rptr[IDX_ELEM_SI] / 33.0);
    ab[IDX_SiOI] = ab[IDX_SiOI] * (16.0 * rptr[IDX_ELEM_O] / 44.0 + 28.0 * rptr[IDX_ELEM_SI] / 44.0);
    ab[IDX_SiOII] = ab[IDX_SiOII] * (16.0 * rptr[IDX_ELEM_O] / 44.0 + 28.0 * rptr[IDX_ELEM_SI] / 44.0);
    ab[IDX_SiOHII] = ab[IDX_SiOHII] * (1.0 * rptr[IDX_ELEM_H] / 45.0 + 16.0 * rptr[IDX_ELEM_O] / 45.0 + 28.0 * rptr[IDX_ELEM_SI] / 45.0);
        // clang-format on
