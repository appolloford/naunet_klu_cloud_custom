...
int EvalRates(realtype *k, realtype *y, NaunetData *u_data) {
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[17] = 4.8e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[18] = 1.1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[19] = 6.72e-10 * exp(+0.5/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[20] = 7.05e-10 * pow(Tgas/300.0,
        -0.03) * exp(+16.7/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[21] = 2.1e-09; }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[25] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[26] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[27] = 1.1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[28] = 1.1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[29] = 1.1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[30] = 5.2e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[31] = 4.6e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[32] = 3.6e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[33] = 4.59e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[34] = 7.6e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[35] = 2e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[36] = 4.2e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[37] = 8.8e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[38] = 4.3e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[39] = 4.3e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[40] = 4.7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[41] = 8.7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[42] = 4.9e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[43] = 9.7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[44] = 4.3e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[45] = 4.8e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[46] = 4.4e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[47] = 3.5e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[48] = 1e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[51] = 3.9e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[52] = 7.93e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[53] = 6.4e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[54] = 3.2e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[55] = 3.1e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[56] = 3.4e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[57] = 3.6e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[58] = 6.3e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[59] = 3.5e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[60] = 3.5e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[61] = 3.1e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[62] = 3.5e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[63] = 6.3e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[64] = 5.2e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[65] = 1.79e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[66] = 3.7e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[67] = 5.7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[68] = 2.58e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[71] = 7.4e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[72] = 3.3e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[73] = 1.2e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[74] = 7.4e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[75] = 1.4e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[76] = 3.4e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[77] = 1.5e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[78] = 1.9e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[79] = 2.96e-09 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[82] = 9.4e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[83] = 1.1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[84] = 2.9e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[85] = 3.7e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[86] = 2.1e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[87] = 2.9e-09; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[88] = 2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[89] = 6.86e-10 * pow(Tgas/300.0,
        0.26) * exp(-224.3/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[90] = 2.1e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[91] = 9.9e-10; }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[95] = 1.5e-09; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[96] = 1.5e-09; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[97] = 1.5e-09; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[98] = 1.7e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[99] = 3.3e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[100] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[101] = 1.4e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[104] = 6.44e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[108] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[112] = 1.1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[113] = 8e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[114] = 7.6e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[115] = 7.2e-15; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[119] = 2.2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[120] = 2.7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[121] = 4.6e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[122] = 3e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[126] = 6.4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[127] = 7.5e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[128] = 6.4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[129] = 3.7e-11; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[132] = 8.1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[133] = 3.2e-10; }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[138] = 6.6e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[139] = 6.3e-15 * pow(Tgas/300.0,
        0.75); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[140] = 5.1e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[141] = 5e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[142] = 9.69e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[143] = 6.05e-11 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[144] = 6.4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[145] = 2.64e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[146] = 3.3e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[147] = 3.3e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[148] = 2.9e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[149] = 2.9e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[150] = 7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[151] = 8.1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[152] = 1.2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[153] = 2.9e-09; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[154] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[155] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[156] = 2.8e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[157] = 1.1e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[158] = 8.25e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[163] = 1.2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[164] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[167] = 4.51e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[168] = 3.11e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[172] = 4.4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[173] = 5e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[174] = 1e-11; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[178] = 7.12e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[179] = 4.51e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[182] = 7e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[188] = 5e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[189] = 4.2e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[190] = 3.3e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[191] = 7.2e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[192] = 1.9e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[198] = 2e-09 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[203] = 7.8e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[204] = 7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[205] = 4.6e-10; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[206] = 7.2e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[207] = 8.9e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[212] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[213] = 1.2e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[214] = 1.9e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[215] = 3.6e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[216] = 6.5e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[217] = 1.4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[218] = 1e-11; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[223] = 3.59e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[224] = 5.9e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[228] = 2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[229] = 1.6e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[230] = 1.6e-09; }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[294] = 1.5e-07 * pow(Tgas/300.0,
        -0.42); }
    ...
    if (Tgas>=10.0 && Tgas<1000.0) { k[297] = 1.6e-07 * pow(Tgas/300.0,
        -0.6); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[298] = 7.75e-08 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[299] = 1.95e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<1000.0) { k[300] = 2e-07 * pow(Tgas/300.0, -0.4);
    }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[301] = 1.75e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[302] = 1.75e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[303] = 1.8e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[304] = 2e-07 * pow(Tgas/300.0,
        -0.48); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[305] = 1.6e-08 * pow(Tgas/300.0,
        -0.43); }
        
    if (Tgas>=10.0 && Tgas<1000.0) { k[306] = 2.5e-08 * pow(Tgas/300.0,
        -0.7); }
        
    if (Tgas>=10.0 && Tgas<1000.0) { k[307] = 7.5e-08 * pow(Tgas/300.0,
        -0.7); }
        
    if (Tgas>=10.0 && Tgas<1000.0) { k[308] = 2.5e-07 * pow(Tgas/300.0,
        -0.7); }
        
    if (Tgas>=10.0 && Tgas<1000.0) { k[309] = 1.6e-07 * pow(Tgas/300.0,
        -0.7); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[310] = 1.5e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[311] = 1.5e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<1000.0) { k[312] = 3.9e-08 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<1000.0) { k[313] = 3.05e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<1000.0) { k[314] = 8.6e-08 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<1000.0) { k[323] = 5.6e-09 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[327] = 9.3e-08 * pow(Tgas/300.0,
        -0.65); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[328] = 9.5e-08 * pow(Tgas/300.0,
        -0.65); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[329] = 9.5e-08 * pow(Tgas/300.0,
        -0.65); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[330] = 2.4e-07 * pow(Tgas/300.0,
        -0.69); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[331] = 6e-08 * pow(Tgas/300.0, -0.64);
    }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[332] = 8.1e-07 * pow(Tgas/300.0,
        -0.64); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[333] = 3.2e-07 * pow(Tgas/300.0,
        -0.64); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[334] = 3e-07 * pow(Tgas/300.0, -0.5);
    }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[335] = 1.1e-07 * pow(Tgas/300.0,
        -1.0); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[336] = 1e-08 * pow(Tgas/300.0, -0.6);
    }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[337] = 1.7e-07 * pow(Tgas/300.0,
        -0.3); }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[340] = 4.3e-08 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[343] = 1.55e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[344] = 1.55e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[345] = 4.3e-07 * pow(Tgas/300.0,
        -0.37); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[346] = 1.95e-07 * pow(Tgas/300.0,
        -0.7); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[347] = 3e-07 * pow(Tgas/300.0, -0.5);
    }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[348] = 3.75e-08 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[349] = 2e-07 * pow(Tgas/300.0, -0.5);
    }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[350] = 1.5e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[351] = 1.5e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[352] = 2e-07 * pow(Tgas/300.0, -0.5);
    }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[353] = 1.5e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[354] = 2e-07 * pow(Tgas/300.0, -0.5);
    }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[355] = 1.5e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[356] = 1.5e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[357] = 1.5e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[358] = 1.5e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[359] = 1.5e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[360] = 1.5e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[361] = 1.5e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[362] = 2e-07 * pow(Tgas/300.0, -0.5);
    }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[363] = 1.5e-07 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[364] = 1.5e-07 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[367] = 1.1e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[370] = 9e-10 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[374] = 1.2e-10 * exp(+0.5/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[375] = 7.8e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[376] = 3.42e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[377] = 4.54e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[378] = 3.8e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[379] = 7.7e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[380] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[381] = 1.1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[382] = 5.4e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[383] = 1.1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[384] = 1e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[385] = 1.1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[386] = 1.1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[387] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[388] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[389] = 1.1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[390] = 1.6e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[391] = 5.2e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[392] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[393] = 1.2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[394] = 2e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[395] = 1e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[398] = 1.6e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[408] = 1.9e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[411] = 1e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[412] = 9.7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[413] = 1e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[414] = 3.5e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[415] = 7.5e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[416] = 1.6e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[420] = 9.1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[421] = 7.5e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[422] = 4.3e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[423] = 4.3e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[424] = 4.7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[425] = 9.4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[426] = 8.7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[427] = 4.35e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[428] = 4.35e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[429] = 8.6e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[430] = 8.6e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[431] = 8.6e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[432] = 1.4e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[433] = 4.9e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[434] = 9.6e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[435] = 4.3e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[436] = 8.5e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[437] = 4.8e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[438] = 8.2e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[442] = 5e-12; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[443] = 4e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[444] = 4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[445] = 7.2e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[446] = 1.8e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[447] = 1.2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[448] = 1.4e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[451] = 4.55e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[452] = 9.35e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[453] = 1.4e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[454] = 1.04e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[455] = 7e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[456] = 9.3e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[457] = 1.31e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[477] = 6e-10 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[481] = 8.6e-11; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[485] = 7.8e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[486] = 1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[487] = 8.8e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[488] = 8.4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[489] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[490] = 7.9e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[491] = 1.4e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[495] = 2.3e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[496] = 3.5e-09; }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[502] = 7.94e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[503] = 4e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[504] = 1.9e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[505] = 1.5e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[506] = 1.5e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[507] = 1.5e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[508] = 1.7e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[509] = 2.4e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[510] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[511] = 2.3e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[514] = 2.35e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[515] = 2.16e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[516] = 2.08e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[519] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[520] = 1.3e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[521] = 2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[522] = 1.9e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[523] = 7.6e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[524] = 1.1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[525] = 1.9e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[526] = 1.5e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[527] = 7.6e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=154.0 && Tgas<3000.0) { k[528] = 1e-10 * exp(-4640.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[529] = 1.2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[530] = 1.6e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[531] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[532] = 7.5e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[533] = 7.5e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[534] = 6.4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[535] = 9e-10; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[536] = 3.7e-14 * exp(-35.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[537] = 1.5e-09; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[538] = 1e-09 * exp(-85.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[539] = 2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[540] = 2.25e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[541] = 1.28e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[542] = 2.7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[543] = 1.7e-09; }
        
    if (Tgas>=80.0 && Tgas<300.0) { k[544] = 6.4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[545] = 1.01e-09; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[546] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[547] = 3.2e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[548] = 3.2e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[549] = 7.7e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[550] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[553] = 5e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[569] = 5e-10 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[573] = 8e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[574] = 2e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[575] = 2e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[576] = 2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[577] = 1.7e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[578] = 2.1e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[581] = 2e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[582] = 2e-09; }
        
    if (Tgas>=10.0 && Tgas<400.0) { k[583] = 1.36e-09 * pow(Tgas/300.0,
        -0.14) * exp(+3.4/Tgas); }
        
    if (Tgas>=10.0 && Tgas<400.0) { k[584] = 8.49e-10 * pow(Tgas/300.0,
        0.07) * exp(-5.2/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[590] = 2e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[591] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[592] = 1.8e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[595] = 7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[596] = 1.1e-09; }
        
    if (Tgas>=10.0 && Tgas<3000.0) { k[597] = 9.3e-10 * exp(-100.0/Tgas); }
        
    if (Tgas>=5.0 && Tgas<400.0) { k[598] = 3.42e-10 * pow(Tgas/300.0,
        -0.16) * exp(-1.4/Tgas); }
        
    if (Tgas>=5.0 && Tgas<400.0) { k[599] = 7.98e-10 * pow(Tgas/300.0,
        -0.16) * exp(-1.4/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[600] = 1.3e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[601] = 3.7e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[602] = 2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[603] = 2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[604] = 2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[605] = 2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[606] = 2e-09 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[609] = 4e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[610] = 1.8e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[611] = 2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[612] = 9.7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[613] = 2e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<1000.0) { k[614] = 9.06e-10 * pow(Tgas/300.0,
        -0.37) * exp(-29.1/Tgas); }
        
    if (Tgas>=236.0 && Tgas<300.0) { k[615] = 1e-09 * exp(-7080.0/Tgas); }
        
    if (Tgas>=352.0 && Tgas<41000.0) { k[616] = 7e-10 * exp(-10560.0/Tgas);
    }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[617] = 1e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[618] = 9.1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[619] = 1.9e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[620] = 2.1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[621] = 1.4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[622] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[626] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=205.0 && Tgas<565.0) { k[629] = 3.1e-09 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[637] = 2e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[638] = 1.4e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[639] = 8.7e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[652] = 1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[653] = 7.5e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[654] = 7.5e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[655] = 1.8e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[658] = 2.4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[659] = 9.5e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[660] = 8.5e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[661] = 4.8e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[665] = 8.7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[666] = 1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[667] = 1.1e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[668] = 4e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[669] = 1.6e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[675] = 2e-09 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[681] = 3e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[682] = 4.9e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[683] = 5e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[684] = 5e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[685] = 5e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[686] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[687] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[688] = 9.6e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[689] = 8e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[690] = 8e-10 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[694] = 2e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[695] = 1.4e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[696] = 1.1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[697] = 3e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[698] = 3e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[699] = 1.1e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[700] = 2e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[701] = 2e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[702] = 2e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[703] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[704] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[705] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[706] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[707] = 1.41e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[708] = 9.4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[709] = 1.8e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[716] = 4.7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[717] = 5.6e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[718] = 3.8e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[719] = 2.5e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[720] = 1.45e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[727] = 7.9e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[728] = 2.63e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[729] = 3.66e-11; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[733] = 8e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[734] = 9.8e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[735] = 3.3e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[736] = 2.2e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[737] = 6.1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[738] = 1.12e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[739] = 2.8e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[740] = 1.3e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[741] = 9.1e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[742] = 1.8e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[743] = 8.9e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[744] = 7.7e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[745] = 9e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[746] = 2.1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[747] = 1.6e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[748] = 3.85e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[749] = 3.85e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[750] = 3.3e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[751] = 4.41e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[761] = 6.5e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[762] = 1.5e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[763] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[764] = 1.78e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[765] = 2.05e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[766] = 1.64e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[767] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[768] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[772] = 1e-10 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[776] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[777] = 1.19e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[778] = 2.1e-11; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[784] = 9e-10 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[791] = 5e-10 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[807] = 7.7e-10; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[810] = 1.1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[811] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[812] = 9.4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[813] = 1.4e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=205.0 && Tgas<565.0) { k[814] = 1.2e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=20.0 && Tgas<5565.0) { k[815] = 1.2e-09 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[818] = 8.3e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[819] = 3.6e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[820] = 5e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[821] = 1.1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[822] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[823] = 4e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[824] = 1e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[825] = 1.3e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[826] = 1.4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[827] = 7.2e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[828] = 1e-11; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[829] = 6.2e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[830] = 7.1e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[831] = 6e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[832] = 4e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[833] = 6.3e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[834] = 2e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[835] = 2e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[836] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[837] = 1.44e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[838] = 1.05e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[845] = 3.6e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[846] = 6.11e-10; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[847] = 7e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[848] = 1.9e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[849] = 1e-09; }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[855] = 1e-09 * pow(Tgas/300.0,
        -0.5); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[861] = 1.6e-09; }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[862] = 2.4e-11; }
        
    if (Tgas>=1000.0 && Tgas<4000.0) { k[863] = 2.69e-12 *
        exp(-23550.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[864] = 1e-10; }
        
    if (Tgas>=2000.0 && Tgas<5000.0) { k[865] = 8.69e-11 *
        exp(-22600.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[866] = 3.26e-11 * pow(Tgas/300.0,
        -0.1) * exp(+9.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[867] = 3.26e-11 * pow(Tgas/300.0,
        -0.1) * exp(+9.0/Tgas); }
        
    if (Tgas>=1000.0 && Tgas<4000.0) { k[868] = 9.62e-13 *
        exp(-10517.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[869] = 1.2e-10; }
        
    if (Tgas>=133.0 && Tgas<300.0) { k[870] = 1.73e-11 * pow(Tgas/300.0,
        0.5) * exp(-4000.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[871] = 6e-11 * pow(Tgas/300.0,
        -0.16); }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[874] = 1e-10; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[875] = 1e-10; }
        
    if (Tgas>=493.0 && Tgas<41000.0) { k[876] = 2.25e-11 * pow(Tgas/300.0,
        0.5) * exp(-14800.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[877] = 6.59e-11; }
        
    if (Tgas>=300.0 && Tgas<2500.0) { k[878] = 4e-10 * exp(-5000.0/Tgas); }
        
    if (Tgas>=296.0 && Tgas<2500.0) { k[879] = 7.13e-12 * exp(-5050.0/Tgas);
    }
        
    if (Tgas>=83.0 && Tgas<300.0) { k[880] = 5.3e-12 * exp(-2500.0/Tgas); }
        
    if (Tgas>=109.0 && Tgas<300.0) { k[881] = 3.3e-13 * exp(-3270.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<2500.0) { k[882] = 3e-11; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[883] = 1.7e-11; }
        
    if (Tgas>=1500.0 && Tgas<2000.0) { k[884] = 8e-12 * exp(-18000.0/Tgas);
    }
        
    if (Tgas>=295.0 && Tgas<295.0) { k[885] = 6.91e-11; }
        
    if (Tgas>=116.0 && Tgas<300.0) { k[886] = 2.7e-12 * exp(-3500.0/Tgas); }
        
    if (Tgas>=300.0 && Tgas<2000.0) { k[887] = 3.65e-12; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[888] = 3.65e-12; }
    ...
    if (Tgas>=300.0 && Tgas<2500.0) { k[893] = 4.1e-11 * exp(-750.0/Tgas); }
        
    if (Tgas>=1900.0 && Tgas<2600.0) { k[894] = 8e-11; }
        
    if (Tgas>=10.0 && Tgas<2500.0) { k[895] = 1.33e-10; }
        
    if (Tgas>=1200.0 && Tgas<1812.0) { k[896] = 5.01e-11; }
        
    if (Tgas>=1900.0 && Tgas<2300.0) { k[897] = 4.98e-10 *
        exp(-6000.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<2500.0) { k[898] = 3e-11; }
        
    if (Tgas>=100.0 && Tgas<300.0) { k[899] = 1.44e-11 * pow(Tgas/300.0,
        0.5) * exp(-3000.0/Tgas); }
        
    if (Tgas>=100.0 && Tgas<300.0) { k[900] = 1.44e-11 * pow(Tgas/300.0,
        0.5) * exp(-3000.0/Tgas); }
        
    if (Tgas>=1950.0 && Tgas<2300.0) { k[901] = 7.13e-12 *
        exp(-5052.0/Tgas); }
    ...
    if (Tgas>=300.0 && Tgas<2500.0) { k[905] = 2e-10; }
        
    if (Tgas>=10.0 && Tgas<913.0) { k[906] = 3.32e-12; }
        
    if (Tgas>=300.0 && Tgas<2000.0) { k[907] = 4.76e-17 * pow(Tgas/300.0,
        5.77) * exp(+151.0/Tgas); }
        
    if (Tgas>=300.0 && Tgas<2500.0) { k[908] = 9.55e-14 * exp(-4890.0/Tgas);
    }
        
    if (Tgas>=298.0 && Tgas<298.0) { k[909] = 5.41e-12; }
        
    if (Tgas>=1100.0 && Tgas<2080.0) { k[910] = 4e-12 * exp(-7900.0/Tgas); }
        
    if (Tgas>=298.0 && Tgas<3000.0) { k[911] = 5.64e-13 * exp(-4500.0/Tgas);
    }
        
    if (Tgas>=1700.0 && Tgas<2000.0) { k[912] = 1.66e-12; }
        
    if (Tgas>=1165.0 && Tgas<41000.0) { k[913] = 5.3e-12 *
        exp(-34975.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<2500.0) { k[914] = 6e-12; }
        
    if (Tgas>=354.0 && Tgas<925.0) { k[915] = 3.6e-11 * exp(-202.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<2500.0) { k[916] = 1.3e-10; }
        
    if (Tgas>=298.0 && Tgas<2500.0) { k[917] = 3.27e-14 * pow(Tgas/300.0,
        2.2) * exp(-2240.0/Tgas); }
        
    if (Tgas>=700.0 && Tgas<700.0) { k[918] = 1.7e-12; }
        
    if (Tgas>=300.0 && Tgas<1000.0) { k[919] = 1.2e-10 * exp(-1400.0/Tgas);
    }
        
    if (Tgas>=160.0 && Tgas<2500.0) { k[920] = 3.14e-12 * pow(Tgas/300.0,
        1.53) * exp(-504.0/Tgas); }
        
    if (Tgas>=300.0 && Tgas<2500.0) { k[921] = 6.7e-11 * exp(-28640.0/Tgas);
    }
        
    if (Tgas>=178.0 && Tgas<3000.0) { k[922] = 3.77e-13 * pow(Tgas/300.0,
        2.42) * exp(-1162.0/Tgas); }
        
    if (Tgas>=100.0 && Tgas<300.0) { k[923] = 2.94e-13 * pow(Tgas/300.0,
        0.5) * exp(-3000.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[926] = 1.73e-11; }
    ...
    if (Tgas>=13.0 && Tgas<708.0) { k[930] = 1.2e-10 * pow(Tgas/300.0,
        -0.13); }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[935] = 7.6e-12 * pow(Tgas/300.0,
        -0.48); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[936] = 7.6e-12 * pow(Tgas/300.0,
        -0.48); }
        
    if (Tgas>=100.0 && Tgas<300.0) { k[937] = 1.44e-11 * pow(Tgas/300.0,
        0.5) * exp(-3000.0/Tgas); }
        
    if (Tgas>=251.0 && Tgas<300.0) { k[938] = 2.94e-13 * pow(Tgas/300.0,
        0.5) * exp(-7550.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<2000.0) { k[939] = 6.02e-11 * pow(Tgas/300.0,
        0.1) * exp(+4.5/Tgas); }
        
    if (Tgas>=10.0 && Tgas<6000.0) { k[940] = 2.52e-11 * exp(-2381.0/Tgas);
    }
        
    if (Tgas>=166.0 && Tgas<300.0) { k[941] = 1.44e-11 * pow(Tgas/300.0,
        0.5) * exp(-5000.0/Tgas); }
        
    if (Tgas>=297.0 && Tgas<2500.0) { k[942] = 2.6e-10 * pow(Tgas/300.0,
        -0.47) * exp(-826.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<2500.0) { k[943] = 1e-10; }
        
    if (Tgas>=10.0 && Tgas<2500.0) { k[944] = 3e-11; }
        
    if (Tgas>=297.0 && Tgas<2500.0) { k[945] = 7.02e-11 * pow(Tgas/300.0,
        -0.27) * exp(-8.3/Tgas); }
        
    if (Tgas>=300.0 && Tgas<1500.0) { k[946] = 1.6e-13; }
        
    if (Tgas>=500.0 && Tgas<4430.0) { k[947] = 1.62e-10 *
        exp(-21205.0/Tgas); }
    ...
    if (Tgas>=296.0 && Tgas<296.0) { k[950] = 2.2e-10; }
        
    if (Tgas>=10.0 && Tgas<1900.0) { k[951] = 3.32e-12 * exp(-6170.0/Tgas);
    }
        
    if (Tgas>=300.0 && Tgas<2500.0) { k[952] = 1.48e-10 *
        exp(-17000.0/Tgas); }
        
    if (Tgas>=300.0 && Tgas<6000.0) { k[953] = 5.99e-12 *
        exp(-24075.0/Tgas); }
        
    if (Tgas>=250.0 && Tgas<2500.0) { k[954] = 5.6e-10 * exp(-12160.0/Tgas);
    }
        
    if (Tgas>=300.0 && Tgas<2500.0) { k[955] = 6.64e-10 *
        exp(-11700.0/Tgas); }
    ...
    if (Tgas>=300.0 && Tgas<2500.0) { k[958] = 5.46e-10 * exp(-1943.0/Tgas);
    }
        
    if (Tgas>=200.0 && Tgas<3500.0) { k[959] = 4.04e-13 * pow(Tgas/300.0,
        2.87) * exp(-820.0/Tgas); }
        
    if (Tgas>=1600.0 && Tgas<2850.0) { k[960] = 1.69e-09 *
        exp(-18095.0/Tgas); }
        
    if (Tgas>=200.0 && Tgas<2500.0) { k[961] = 2.05e-15 * pow(Tgas/300.0,
        3.89) * exp(-1400.0/Tgas); }
        
    if (Tgas>=2601.0 && Tgas<2788.0) { k[962] = 5.96e-11 *
        exp(-7782.0/Tgas); }
        
    if (Tgas>=300.0 && Tgas<2500.0) { k[963] = 2.4e-10 * exp(-28500.0/Tgas);
    }
        
    if (Tgas>=300.0 && Tgas<2500.0) { k[964] = 3.16e-10 *
        exp(-21890.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<2500.0) { k[967] = 2.2e-10; }
        
    if (Tgas>=300.0 && Tgas<2500.0) { k[968] = 1e-10 * exp(-7600.0/Tgas); }
        
    if (Tgas>=300.0 && Tgas<2500.0) { k[969] = 5.94e-13 * pow(Tgas/300.0,
        3.0) * exp(-4045.0/Tgas); }
        
    if (Tgas>=300.0 && Tgas<2000.0) { k[970] = 1.31e-10 * exp(-80.0/Tgas); }
        
    if (Tgas>=300.0 && Tgas<15223.0) { k[971] = 3.38e-10 *
        exp(-13163.0/Tgas); }
        
    if (Tgas>=2590.0 && Tgas<41000.0) { k[972] = 1.1e-10 * pow(Tgas/300.0,
        0.5) * exp(-77700.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[973] = 1e-10; }
    ...
    if (Tgas>=300.0 && Tgas<2500.0) { k[976] = 6.2e-10 * exp(-12500.0/Tgas);
    }
        
    if (Tgas>=200.0 && Tgas<2500.0) { k[977] = 1.5e-10; }
        
    if (Tgas>=1200.0 && Tgas<1812.0) { k[978] = 6.61e-11 *
        exp(-51598.0/Tgas); }
    ...
    if (Tgas>=200.0 && Tgas<2500.0) { k[984] = 7.8e-13 * pow(Tgas/300.0,
        2.4) * exp(-4990.0/Tgas); }
        
    if (Tgas>=80.0 && Tgas<300.0) { k[985] = 1.73e-11 * pow(Tgas/300.0, 0.5)
        * exp(-2400.0/Tgas); }
        
    if (Tgas>=24.0 && Tgas<300.0) { k[986] = 1.4e-10 * exp(-740.0/Tgas); }
        
    if (Tgas>=300.0 && Tgas<3000.0) { k[987] = 9.29e-10 * pow(Tgas/300.0,
        -0.1) * exp(-35220.0/Tgas); }
        
    if (Tgas>=1500.0 && Tgas<4524.0) { k[988] = 3.6e-10 *
        exp(-24910.0/Tgas); }
        
    if (Tgas>=250.0 && Tgas<4000.0) { k[989] = 2.61e-10 * exp(-8156.0/Tgas);
    }
        
    if (Tgas>=245.0 && Tgas<2500.0) { k[990] = 5e-11 * exp(-866.0/Tgas); }
        
    if (Tgas>=230.0 && Tgas<2500.0) { k[991] = 2.06e-11 * pow(Tgas/300.0,
        0.84) * exp(-277.0/Tgas); }
        
    if (Tgas>=230.0 && Tgas<2500.0) { k[992] = 1.66e-10 * exp(-413.0/Tgas);
    }
        
    if (Tgas>=500.0 && Tgas<2500.0) { k[993] = 1.87e-11 * pow(Tgas/300.0,
        0.9) * exp(-2924.0/Tgas); }
        
    if (Tgas>=295.0 && Tgas<1490.0) { k[994] = 1.26e-10 * exp(-515.0/Tgas);
    }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[995] = 1e-10; }
        
    if (Tgas>=300.0 && Tgas<2500.0) { k[996] = 6.99e-14 * pow(Tgas/300.0,
        2.8) * exp(-1950.0/Tgas); }
        
    if (Tgas>=303.0 && Tgas<376.0) { k[997] = 3.6e-11; }
        
    if (Tgas>=300.0 && Tgas<2500.0) { k[998] = 3e-11; }
        
    if (Tgas>=300.0 && Tgas<2500.0) { k[999] = 1e-12 * exp(-1000.0/Tgas); }
        
    if (Tgas>=295.0 && Tgas<2500.0) { k[1000] = 1.2e-11; }
        
    if (Tgas>=298.0 && Tgas<298.0) { k[1001] = 7.6e-13; }
        
    if (Tgas>=200.0 && Tgas<2500.0) { k[1002] = 4.64e-12 * pow(Tgas/300.0,
        0.7) * exp(+25.6/Tgas); }
        
    if (Tgas>=300.0 && Tgas<2500.0) { k[1003] = 5e-11; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1004] = 1e-12; }
    ...
    if (Tgas>=1000.0 && Tgas<4000.0) { k[1007] = 9.96e-13 *
        exp(-20380.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<2000.0) { k[1008] = 7.4e-11 * pow(Tgas/300.0,
        0.26) * exp(-8.4/Tgas); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1009] = 1.3e-11 * pow(Tgas/300.0,
        0.5); }
        
    if (Tgas>=253.0 && Tgas<352.0) { k[1010] = 3.32e-13; }
        
    if (Tgas>=10.0 && Tgas<299.0) { k[1011] = 1e-10 * pow(Tgas/300.0, 0.18);
    }
        
    if (Tgas>=291.0 && Tgas<523.0) { k[1012] = 3.2e-13 * exp(-1710.0/Tgas);
    }
        
    if (Tgas>=200.0 && Tgas<2500.0) { k[1013] = 1e-10 * exp(-200.0/Tgas); }
        
    if (Tgas>=33.0 && Tgas<300.0) { k[1014] = 5.71e-12 * pow(Tgas/300.0,
        0.5) * exp(-1000.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1015] = 1.7e-10; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1016] = 1e-10; }
        
    if (Tgas>=33.0 && Tgas<300.0) { k[1017] = 2.94e-12 * pow(Tgas/300.0,
        0.5) * exp(-1000.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<1400.0) { k[1018] = 4.98e-11; }
        
    if (Tgas>=300.0 && Tgas<300.0) { k[1019] = 2.41e-12; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1020] = 1e-12; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1021] = 1e-12; }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[1024] = 1.7e-13; }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[1027] = 5e-11; }
    ...
    if (Tgas>=1500.0 && Tgas<2150.0) { k[1030] = 1.49e-12; }
    ...
    if (Tgas>=33.0 && Tgas<300.0) { k[1035] = 2.94e-12 * pow(Tgas/300.0,
        0.5) * exp(-1000.0/Tgas); }
        
    if (Tgas>=600.0 && Tgas<3000.0) { k[1036] = 1.83e-12 * pow(Tgas/300.0,
        1.6) * exp(-14090.0/Tgas); }
        
    if (Tgas>=1300.0 && Tgas<1700.0) { k[1037] = 5.25e-10 *
        exp(-13470.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1038] = 1.7e-11; }
        
    if (Tgas>=298.0 && Tgas<298.0) { k[1039] = 1.16e-09; }
    ...
    if (Tgas>=298.0 && Tgas<3300.0) { k[1042] = 7.4e-10 *
        exp(-10540.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<299.0) { k[1046] = 6.6e-11; }
        
    if (Tgas>=250.0 && Tgas<3000.0) { k[1047] = 1.16e-11; }
        
    if (Tgas>=298.0 && Tgas<3000.0) { k[1048] = 3.11e-12 * pow(Tgas/300.0,
        1.2); }
        
    if (Tgas>=298.0 && Tgas<3000.0) { k[1049] = 3.32e-11; }
        
    if (Tgas>=298.0 && Tgas<3000.0) { k[1050] = 2.93e-12 * pow(Tgas/300.0,
        0.1) * exp(-5800.0/Tgas); }
        
    if (Tgas>=1573.0 && Tgas<4700.0) { k[1051] = 2.51e-11 *
        exp(-30653.0/Tgas); }
        
    if (Tgas>=780.0 && Tgas<41000.0) { k[1052] = 2.8e-12 *
        exp(-23400.0/Tgas); }
        
    if (Tgas>=290.0 && Tgas<2660.0) { k[1053] = 4.55e-11 * pow(Tgas/300.0,
        -1.33) * exp(-242.0/Tgas); }
        
    if (Tgas>=298.0 && Tgas<298.0) { k[1054] = 1.32e-12; }
        
    if (Tgas>=25.0 && Tgas<300.0) { k[1055] = 8.1e-11 * exp(-773.0/Tgas); }
        
    if (Tgas>=298.0 && Tgas<2500.0) { k[1056] = 2.29e-12 * pow(Tgas/300.0,
        2.2) * exp(-3820.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<294.0) { k[1057] = 2.54e-11; }
        
    if (Tgas>=200.0 && Tgas<5000.0) { k[1058] = 5.37e-11 *
        exp(-13800.0/Tgas); }
        
    if (Tgas>=300.0 && Tgas<6000.0) { k[1059] = 2.46e-11 *
        exp(-26567.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1060] = 1e-10; }
    ...
    if (Tgas>=300.0 && Tgas<4000.0) { k[1063] = 6.21e-10 *
        exp(-12439.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<2500.0) { k[1066] = 5e-11; }
        
    if (Tgas>=10.0 && Tgas<2500.0) { k[1067] = 5e-11; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1068] = 1e-12; }
    ...
    if (Tgas>=1400.0 && Tgas<4700.0) { k[1071] = 2.51e-10 *
        exp(-38602.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<3000.0) { k[1072] = 6.3e-11 * pow(Tgas/300.0,
        -0.1); }
        
    if (Tgas>=10.0 && Tgas<3000.0) { k[1073] = 7e-12 * pow(Tgas/300.0,
        -0.1); }
        
    if (Tgas>=298.0 && Tgas<2500.0) { k[1074] = 1.89e-11 *
        exp(-4003.0/Tgas); }
        
    if (Tgas>=200.0 && Tgas<2500.0) { k[1075] = 9.82e-12 * pow(Tgas/300.0,
        -0.21) * exp(-5.2/Tgas); }
        
    if (Tgas>=200.0 && Tgas<5000.0) { k[1076] = 1.18e-11 *
        exp(-20413.0/Tgas); }
        
    if (Tgas>=200.0 && Tgas<2500.0) { k[1077] = 5.76e-11 * pow(Tgas/300.0,
        -0.3) * exp(-7.5/Tgas); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1078] = 1e-10; }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[1081] = 4e-11; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1082] = 4e-11; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1083] = 5e-11; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1084] = 5e-11; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1085] = 8e-11; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1086] = 1.2e-10; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1087] = 1.4e-10; }
        
    if (Tgas>=280.0 && Tgas<1000.0) { k[1088] = 1.98e-11 *
        exp(-1183.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1089] = 1e-10; }
        
    if (Tgas>=500.0 && Tgas<2500.0) { k[1090] = 1e-11 * exp(-1000.0/Tgas); }
        
    if (Tgas>=500.0 && Tgas<2500.0) { k[1091] = 7e-11; }
        
    if (Tgas>=80.0 && Tgas<3150.0) { k[1092] = 2.81e-13 * exp(-176.0/Tgas);
    }
    ...
    if (Tgas>=500.0 && Tgas<2500.0) { k[1095] = 1.07e-13 *
        exp(-5892.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<2500.0) { k[1096] = 1.7e-10; }
    ...
    if (Tgas>=503.0 && Tgas<41000.0) { k[1099] = 5.2e-12 *
        exp(-15100.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<3560.0) { k[1102] = 1e-10; }
        
    if (Tgas>=300.0 && Tgas<3160.0) { k[1103] = 2.72e-11 * exp(-282.0/Tgas);
    }
        
    if (Tgas>=2720.0 && Tgas<5190.0) { k[1104] = 1.3e-09 *
        exp(-34513.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[1200] = 1e-17; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1201] = 5.09e-18 * pow(Tgas/300.0,
        -0.71) * exp(-11.6/Tgas); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1202] = 3e-18; }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[1205] = 1.7e-17; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1206] = 1e-17; }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[1211] = 4.9e-20 * pow(Tgas/300.0,
        1.58); }
    ...
    if (Tgas>=10.0 && Tgas<300.0) { k[1215] = 1.1e-10 * pow(Tgas/300.0,
        -0.5); }
        
    if (Tgas>=10.0 && Tgas<20000.0) { k[1216] = 3.5e-12 * pow(Tgas/300.0,
        -0.75); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[1217] = 1.1e-10 * pow(Tgas/300.0,
        -0.7); }
    ...
    if (Tgas<10000.0) { k[1307] = mantabund > 1e-30 ? (eb_h2d >= 1090.0 ?
    ...
    if (Tgas<10000.0) { k[1309] = mantabund > 1e-30 ? (opt_uvd *
        (G0*habing*exp(-Av*3.02) + crphot * (zeta/zism)) * 0.001 * nmono * 4.0 *
        gxsec) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1317] = mantabund > 1e-30 ? (opt_uvd *
        (G0*habing*exp(-Av*3.02) + crphot * (zeta/zism)) * 0.0013 * nmono * 4.0
        * gxsec) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1333] = mantabund > 1e-30 ? (opt_uvd *
        (G0*habing*exp(-Av*3.02) + crphot * (zeta/zism)) * 0.0027 * nmono * 4.0
        * gxsec) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1337] = mantabund > 1e-30 ? (opt_uvd *
        (G0*habing*exp(-Av*3.02) + crphot * (zeta/zism)) * 0.00018 * nmono * 4.0
        * gxsec) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1361] = mantabund > 1e-30 ? (opt_uvd *
        (G0*habing*exp(-Av*3.02) + crphot * (zeta/zism)) * 0.0021 * nmono * 4.0
        * gxsec) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1385] = mantabund > 1e-30 ? (opt_uvd *
        (G0*habing*exp(-Av*3.02) + crphot * (zeta/zism)) * 0.0023 * nmono * 4.0
        * gxsec) : 0.0; }
