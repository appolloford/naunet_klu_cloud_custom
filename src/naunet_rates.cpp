-09 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[716] = 4.7e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[717] = 5.6e-11 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[718] = 3.8e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[719] = 2.5e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[727] = 7.9e-11 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[734] = 9.8e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[735] = 3.3e-09 * pow(Tgas/300.0,
        -0.5) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[736] = 2.2e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[737] = 6.1e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[738] = 1.12e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[739] = 2.8e-11 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[740] = 1.3e-09 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[741] = 9.1e-11 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[742] = 1.8e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[743] = 8.9e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[744] = 7.7e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[745] = 9e-11 * pow(Tgas/300.0, 0.0)
        * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[746] = 2.1e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[750] = 3.3e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[761] = 6.5e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[778] = 2.1e-11 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[807] = 7.7e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[810] = 1.1e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[811] = 1e-09 * pow(Tgas/300.0, -0.5)
        * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[812] = 9.4e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[818] = 8.3e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[821] = 1.1e-09 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[825] = 1.3e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[826] = 1.4e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[827] = 7.2e-11 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[828] = 1e-11 * pow(Tgas/300.0, 0.0)
        * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[829] = 6.2e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[830] = 7.1e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[833] = 6.3e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[845] = 3.6e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[848] = 1.9e-09 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<41000.0) { k[861] = 1.6e-09 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<41000.0) { k[862] = 2.4e-11 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=295.0 && Tgas<295.0) { k[885] = 6.91e-11 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=300.0 && Tgas<2500.0) { k[893] = 4.1e-11 * pow(Tgas/300.0,
        0.0) * exp(-750.0/Tgas); }
        
    if (Tgas>=1900.0 && Tgas<2600.0) { k[894] = 8e-11 * pow(Tgas/300.0, 0.0)
        * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<2500.0) { k[895] = 1.33e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=298.0 && Tgas<298.0) { k[909] = 5.41e-12 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=700.0 && Tgas<700.0) { k[918] = 1.7e-12 * pow(Tgas/300.0, 0.0)
        * exp(-0.0/Tgas); }
        
    if (Tgas>=300.0 && Tgas<1000.0) { k[919] = 1.2e-10 * pow(Tgas/300.0,
        0.0) * exp(-1400.0/Tgas); }
        
    if (Tgas>=160.0 && Tgas<2500.0) { k[920] = 3.14e-12 * pow(Tgas/300.0,
        1.53) * exp(-504.0/Tgas); }
        
    if (Tgas>=300.0 && Tgas<2500.0) { k[921] = 6.7e-11 * pow(Tgas/300.0,
    ...
    if (Tgas>=10.0 && Tgas<6000.0) { k[940] = 2.52e-11 * pow(Tgas/300.0,
        0.0) * exp(-2381.0/Tgas); }
    ...
    if (Tgas>=300.0 && Tgas<1500.0) { k[946] = 1.6e-13 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=296.0 && Tgas<296.0) { k[950] = 2.2e-10 * pow(Tgas/300.0, 0.0)
        * exp(-0.0/Tgas); }
        
    if (Tgas>=10.0 && Tgas<1900.0) { k[951] = 3.32e-12 * pow(Tgas/300.0,
        0.0) * exp(-6170.0/Tgas); }
    ...
    if (Tgas>=250.0 && Tgas<2500.0) { k[954] = 5.6e-10 * pow(Tgas/300.0,
    ...
    if (Tgas>=300.0 && Tgas<2500.0) { k[963] = 2.4e-10 * pow(Tgas/300.0,
    ...
    if (Tgas>=300.0 && Tgas<2500.0) { k[976] = 6.2e-10 * pow(Tgas/300.0,
        0.0) * exp(-12500.0/Tgas); }
        
    if (Tgas>=200.0 && Tgas<2500.0) { k[977] = 1.5e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=298.0 && Tgas<298.0) { k[1001] = 7.6e-13 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=291.0 && Tgas<523.0) { k[1012] = 3.2e-13 * pow(Tgas/300.0,
        0.0) * exp(-1710.0/Tgas); }
    ...
    if (Tgas>=300.0 && Tgas<300.0) { k[1019] = 2.41e-12 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=298.0 && Tgas<298.0) { k[1039] = 1.16e-09 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=298.0 && Tgas<298.0) { k[1054] = 1.32e-12 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<294.0) { k[1057] = 2.54e-11 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas>=10.0 && Tgas<2500.0) { k[1096] = 1.7e-10 * pow(Tgas/300.0,
        0.0) * exp(-0.0/Tgas); }
    ...
    if (Tgas<30.0) { k[1223] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        32.0); }
        
    if (Tgas<30.0) { k[1224] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        43.0); }
        
    if (Tgas<30.0) { k[1225] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        42.0); }
        
    if (Tgas<30.0) { k[1226] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 29.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1227] = 4.57e4 * 0.0 * garea * fr * sqrt(Tgas /
        28.0); }
        
    if (Tgas<30.0) { k[1228] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        28.0); }
        
    if (Tgas<30.0) { k[1229] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        44.0); }
        
    if (Tgas<30.0) { k[1230] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        29.0); }
        
    if (Tgas<30.0) { k[1231] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 28.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1232] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 29.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1233] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        30.0); }
        
    if (Tgas<30.0) { k[1234] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 30.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1235] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        31.0); }
        
    if (Tgas<30.0) { k[1236] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 31.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1237] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        32.0); }
        
    if (Tgas<30.0) { k[1238] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 32.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1239] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        40.0); }
        
    if (Tgas<30.0) { k[1240] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        52.0); }
        
    if (Tgas<30.0) { k[1241] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 40.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1242] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 52.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1243] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        64.0); }
        
    if (Tgas<30.0) { k[1244] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 64.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1245] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 44.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1246] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 45.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1247] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        46.0); }
        
    if (Tgas<30.0) { k[1248] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 33.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1249] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 31.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1250] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        12.0); }
        
    if (Tgas<30.0) { k[1251] = 4.57e4 * 0.9 * garea * fr * sqrt(Tgas /
        28.0); }
        
    if (Tgas<30.0) { k[1252] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        30.0); }
        
    if (Tgas<30.0) { k[1253] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        13.0); }
        
    if (Tgas<30.0) { k[1254] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        17.0); }
        
    if (Tgas<30.0) { k[1255] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        30.0); }
        
    if (Tgas<30.0) { k[1256] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        14.0); }
        
    if (Tgas<30.0) { k[1257] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        18.0); }
        
    if (Tgas<30.0) { k[1258] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        44.0); }
        
    if (Tgas<30.0) { k[1259] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        15.0); }
        
    if (Tgas<30.0) { k[1260] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        16.0); }
        
    if (Tgas<30.0) { k[1261] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        29.0); }
        
    if (Tgas<30.0) { k[1262] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        28.0); }
        
    if (Tgas<30.0) { k[1263] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        26.0); }
        
    if (Tgas<30.0) { k[1264] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 12.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1265] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        15.0); }
        
    if (Tgas<30.0) { k[1266] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        27.0); }
        
    if (Tgas<30.0) { k[1267] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        17.0); }
        
    if (Tgas<30.0) { k[1268] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 14.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1269] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 16.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1270] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 32.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1271] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 28.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1272] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 13.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1273] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 15.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1274] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 17.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1275] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 28.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1276] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 26.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1277] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 30.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1278] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 14.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1279] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 16.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1280] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 18.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1281] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 29.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1282] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 27.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1283] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 17.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1284] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 30.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1285] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 15.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1286] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 19.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1287] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 45.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1288] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 16.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1289] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        16.0); }
        
    if (Tgas<30.0) { k[1290] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        14.0); }
        
    if (Tgas<30.0) { k[1291] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        16.0); }
        
    if (Tgas<30.0) { k[1292] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        32.0); }
        
    if (Tgas<30.0) { k[1293] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        46.0); }
        
    if (Tgas<30.0) { k[1294] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        31.0); }
        
    if (Tgas<30.0) { k[1295] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 31.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1296] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 32.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1297] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 33.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1298] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        28.0); }
        
    if (Tgas<30.0) { k[1299] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 24.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1300] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        24.0); }
        
    if (Tgas<30.0) { k[1301] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 28.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1302] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas / 29.0)
        * ( 1.0 + 16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<30.0) { k[1303] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        33.0); }
        
    if (Tgas<30.0) { k[1304] = 4.57e4 * 0.1 * garea * fr * sqrt(Tgas /
        28.0); }
        
    if (Tgas<30.0) { k[1305] = 4.57e4 * 1.0 * garea * fr * sqrt(Tgas /
        27.0); }
        
    if (Tgas<30.0) { k[1306] = 4.57e4 * 1.0 * garea * fr * ( 1.0 +
        16.71e-4/(rG * Tgas) ); }
        
    if (Tgas<10000.0) { k[1307] = mantabund > 1e-30 ? (eb_h2d >= 960.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1308] = mantabund > 1e-30 ? (eb_crd >= 960.0 ?
    ...
    if (Tgas<10000.0) { k[1311] = mantabund > 1e-30 ? (eb_h2d >= 5500.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1312] = mantabund > 1e-30 ? (eb_crd >= 5500.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1315] = mantabund > 1e-30 ? (eb_h2d >= 5600.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1316] = mantabund > 1e-30 ? (eb_crd >= 5600.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1323] = mantabund > 1e-30 ? (eb_h2d >= 3700.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1324] = mantabund > 1e-30 ? (eb_crd >= 3700.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1327] = mantabund > 1e-30 ? (eb_h2d >= 3800.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1328] = mantabund > 1e-30 ? (eb_crd >= 3800.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1331] = mantabund > 1e-30 ? (eb_h2d >= 1300.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1332] = mantabund > 1e-30 ? (eb_crd >= 1300.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1335] = mantabund > 1e-30 ? (eb_h2d >= 1100.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1336] = mantabund > 1e-30 ? (eb_crd >= 1100.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1347] = mantabund > 1e-30 ? (eb_h2d >= 4500.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1348] = mantabund > 1e-30 ? (eb_crd >= 4500.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1351] = mantabund > 1e-30 ? (eb_h2d >= 3000.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1352] = mantabund > 1e-30 ? (eb_crd >= 3000.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1355] = mantabund > 1e-30 ? (eb_h2d >= 1200.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1356] = mantabund > 1e-30 ? (eb_crd >= 1200.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1359] = mantabund > 1e-30 ? (eb_h2d >= 5000.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1360] = mantabund > 1e-30 ? (eb_crd >= 5000.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1363] = mantabund > 1e-30 ? (eb_h2d >= 13000.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1364] = mantabund > 1e-30 ? (eb_crd >= 13000.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1367] = mantabund > 1e-30 ? (eb_h2d >= 5000.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1368] = mantabund > 1e-30 ? (eb_crd >= 5000.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1375] = mantabund > 1e-30 ? (eb_h2d >= 4400.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1376] = mantabund > 1e-30 ? (eb_crd >= 4400.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1383] = mantabund > 1e-30 ? (eb_h2d >= 2600.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1384] = mantabund > 1e-30 ? (eb_crd >= 2600.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1391] = mantabund > 1e-30 ? (eb_h2d >= 4400.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1392] = mantabund > 1e-30 ? (eb_crd >= 4400.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1395] = mantabund > 1e-30 ? (eb_h2d >= 4300.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1396] = mantabund > 1e-30 ? (eb_crd >= 4300.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
    ...
    if (Tgas<10000.0) { k[1399] = mantabund > 1e-30 ? (eb_h2d >= 5100.0 ?
        (opt_h2d * h2deseff * 1.0e-17 * sqrt(Tgas) * y[IDX_HI] * nH / mant) :
        0.0) : 0.0; }
        
    if (Tgas<10000.0) { k[1400] = mantabund > 1e-30 ? (eb_crd >= 5100.0 ?
        (opt_crd * 4.0 * pi * crdeseff * ((zeta / zism)) * 1.64e-4 * garea /
        mant) : 0.0) : 0.0; }
